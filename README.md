...
1. Find & replace every "YOUR-USERNAME" with your actual GitHub username.
2. Replace "YOUR_NAME" in the typing animation text with your real name.
3. Replace "your-email@example.com", social links, and "REPO-ONE"/"REPO-TWO" with your real repo names.
4. This file must live in a repo with the EXACT same name as your username
   (e.g. github.com/YOUR-USERNAME/YOUR-USERNAME) and be public — that's what makes
   it show up on your profile page.
5. For the snake animation to work, add this GitHub Actions workflow at
   .github/workflows/snake.yml in that same repo:
...
6. All stats/trophy/streak images are generated live by public services
   (github-readme-stats, github-profile-trophy, etc.) — no extra setup needed
   for those, they just need your username in the URL.
-->
